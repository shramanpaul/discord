...
export const ServerHeader = ({
    ...
    return ( 
        <DropdownMenu>
            ...
            >
                <button className="w-full text-md font-semibold px-3 flex items-center h-12 border-neutral-200 dark:border-neutral-800 border-b-2 hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 trasition">
                    {server.name}
            ...
            <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]">
                ...
                {isAdmin && (
                    <DropdownMenuItem onClick={()=>{console.log("Manage Members Clicked");onOpen("members",{server})}} className="px-3 py-2 text-sm cursor-pointer">
                        Manage Members
                ...
                {!isAdmin && (
                    <DropdownMenuItem
                    onClick={()=>{console.log("Leave server is clicked");onOpen("leaveServer",{ server })}}
