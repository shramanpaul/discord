...
import { Check, CheckIcon, Gavel, Loader2, MoreVertical, Shield, ShieldAlert, ShieldCheck, ShieldIcon, ShieldQuestion } from "lucide-react";
...
export const MembersModal = () => {
  ...
  const onKick=async (memberId:string)=>{
    try{
      ...
      router.refresh();
      onOpen("members",{server: (await response).data}); //
